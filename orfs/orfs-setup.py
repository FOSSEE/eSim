...
KLAYOUT_DEB=BASE_DIR/"library/orfs/klayout_0.30.7-1_amd64.deb"
...
def install_dependencies():
 ...
 "libreadline-dev","zlib1g-dev","qtbase6-dev","qtchooser",
 "qt6-qmake","qtbase6-dev-tools","libboost-all-dev",
