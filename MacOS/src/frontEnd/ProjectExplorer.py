...
class ProjectExplorer(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        from esim_paths import resource_path
        if os.name == 'nt':
            init_path = ''
        ...
        self.treewidget.setStyleSheet(" \
            ...
            border-image: url(" + resource_path('images', 'vline.png') + ") 0;} \
            QTreeView::branch:has-siblings:adjoins-item { \
            border-image: url(" + resource_path('images', 'branch-more.png') + ") 0; } \
            QTreeView::branch:!has-children:!has-siblings:adjoins-item { \
            border-image: url(" + resource_path('images', 'branch-end.png') + ") 0; } \
            QTreeView::branch:has-children:!has-siblings:closed, \
            QTreeView::branch:closed:has-children:has-siblings { \
            border-image: none; \
            image: url(" + resource_path('images', 'branch-closed.png') + "); } \
            QTreeView::branch:open:has-children:!has-siblings, \
            QTreeView::branch:open:has-children:has-siblings  { \
            border-image: none; \
            image: url(" + resource_path('images', 'branch-open.png') + "); } \
        ")
