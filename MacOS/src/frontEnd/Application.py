...
# assisting to find AppConfig.py
...
if os.name == 'nt':
    ...
    # import pathmagic
    # init_path = "../../"
    from esim_paths import resource_path # type: ignore
...
class Application(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args):
        ...
        self.systemTrayIcon.setIcon(QtGui.QIcon(resource_path('images', 'logo.png')))
    ...
    def initToolBar(self):
        ...
        self.newproj = QtWidgets.QAction(
            QtGui.QIcon(resource_path('images', 'newProject.png')),
        ...
        self.openproj = QtWidgets.QAction(
            QtGui.QIcon(resource_path('images', 'openProject.png')),
        ...
        self.closeproj = QtWidgets.QAction(
            QtGui.QIcon(resource_path('images', 'closeProject.png')),
        ...
        self.wrkspce = QtWidgets.QAction(
            QtGui.QIcon(resource_path('images', 'workspace.ico')),
        ...
        self.helpfile = QtWidgets.QAction(
            QtGui.QIcon(resource_path('images', 'helpProject.png')),
            '<b>Help</b>', self
        )
        ...
        self.devdocs = QtWidgets.QAction(
            QtGui.QIcon(resource_path('images', 'dev_docs.png')),
            '<b>Dev Docs</b>', self
        )
        ...
        self.logopic = QtGui.QPixmap(
            os.path.join(
                os.path.abspath(''), resource_path('images', 'fosseeLogo.png')
            ))
...
def main(args):
    ...
    # Added block by THSS to handle macOS specific setup for KiCad
    if sys.platform == 'darwin':
        try:
            import macOSSetup  # type: ignore
            macOSSetup.run_macos_kicad_setup(show_ui=True)
        except Exception as e:
            print(f"macOS KiCad setup warning: {e}")
    # End of macOS specific block by THSS

    appView = Application()
    appView.hide()

    splash_pix = QtGui.QPixmap(resource_path('images', 'splash_screen_esim.png'))
