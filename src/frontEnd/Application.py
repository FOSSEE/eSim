...
# Setting python path is not neccessary when launched using binaries generated by pyinstaller
# but can be useful for dev launches (using "python2 src/frontEnd/Application.py")
# Toggle comment if required
# Setting PYTHONPATH
# cwd = os.getcwd()
