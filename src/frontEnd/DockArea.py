...
class DockArea(QtWidgets.QMainWindow):
    ...
    def eSimConverter(self):
        ...
        upload_button1.clicked.connect(lambda: self.pspice_converter.upload_file_Pspice(self,file_path_text_box.text()))
        ...
        upload_button.clicked.connect(lambda: self.ltspice_converter.upload_file_LTspice(self,file_path_text_box.text()))
