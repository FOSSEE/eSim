...
class PrcocessNetlist:
    ...
    def readParamInfo(self, kicadNetlist):
        ...
        for eachline in kicadNetlist:
            ...
            if len(eachline) > 1:
                ...
                option = words[0] if len(words) > 0 else "".lower()
                if option == '.param':
    ...
    def insertSpecialSourceParam(self, schematicInfo, sourcelist):
        ...
        for compline in schematicInfo:
            ...
            compName = words[0] if len(words) > 0 else ""
            ...
            if compName[0] == 'v' or compName[0] == 'i':
                ...
                if len(words) > 3 and words[3] == "pulse":
                ...
                elif len(words) > 3 and words[3] == "sine":
                ...
                elif len(words) > 3 and words[3] == "pwl":
                ...
                elif len(words) > 3 and words[3] == "ac":
                ...
                elif len(words) > 3 and words[3] == "exp":
                ...
                elif len(words) > 3 and words[3] == "dc":
