...
function installDependency
{
    ...
    sudo apt install -y libcanberra-gtk3-module #libcanberra-gtk-module <-obsoltete for ubu 25.04
    ...
    elif [[ -n "$(which yum 2> /dev/null)" ]]  then #invalid syntax else fixed
    # Ubuntu
...
{   
    ...
    tar xvf $ghdl.tar.xz #updated cuz gz --> xz
...
if [ $option == "--install" ];then
    ...
    #echo "Removing LLVM......................"  usually llvm is a system wide necessity
