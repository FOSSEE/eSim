...
2. **Offline Python Dependency Installation**: 
   ...
   - *Solution*: All Python packages (and their transitive dependencies like `PyQt6-sip`, `PyQt6-Qt6`, `contourpy`, `cycler`, etc.) were pre-declared as `file` sources in the manifest. We used direct PyPI URLs and validated SHA256 hashes for each `.whl` file.
